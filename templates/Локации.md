...
TABLE WITHOUT ID 
  ...
  type AS "Тип"
FROM ""
WHERE type = "Фортификация"
  AND contains(file.path, "{{projectName}}/Локации/Замки")
  AND file.name != this.file.name
SORT state ASC, province ASC, file.name ASC
```
...
FROM ""
WHERE type = "Ферма"
  AND contains(file.path, "{{projectName}}/Локации/Фермы")
  AND file.name != this.file.name
SORT state ASC, province ASC, file.name ASC
```
...
FROM ""
WHERE type = "Шахта"
  AND contains(file.path, "{{projectName}}/Локации/Шахты")
  AND file.name != this.file.name
SORT state ASC, province ASC, file.name ASC
```
...
FROM ""
WHERE type = "Завод"
  AND contains(file.path, "{{projectName}}/Локации/Заводы")
  AND file.name != this.file.name
SORT state ASC, province ASC, file.name ASC
```
